...
\pagebreak
\lstinputlisting[title=/etc/init.d/galaxy]{galaxy.txt}
...
\pagebreak
\noindent\textbf{Condition 1 with 3 replicates}\\
...
\pagebreak
\noindent\textbf{The default options for cuffdiff}\\
...
\lstinputlisting[language=python,title=Galaxy2Cummerbund.py]{Scripts/Galaxy2Cummerbund.py}
...
\begin{tabular}{|c|c|c|}
\textbf{\footnotesize{Distribution of expression levels}} & \textbf{\footnotesize{Genes scatterplot}} & \textbf{\footnotesize{Genes volcano plot}}\\
\setlength\fboxsep{0pt}\fbox{\includegraphics[scale=.25]{Screenshots/26_distribution_of_expression_levels}}&
\setlength\fboxsep{0pt}\fbox{\includegraphics[scale=.25]{Screenshots/27_scatterplot}}&
\setlength\fboxsep{0pt}\fbox{\includegraphics[scale=.25]{Screenshots/28_volcano}}\\
\end{tabular}
...
\setlength\fboxsep{0pt}\fbox{\includegraphics[scale=.25]{Screenshots/29_extract_workflow}}

\noindent\textbf{The extracted work flow}\vspace{1em}\\
\setlength\fboxsep{0pt}\fbox{\includegraphics[width=\textwidth]{Screenshots/30_workflow}}
...
\bibitem{Galaxy01} Goecks, J, Nekrutenko, A, Taylor, J and The Galaxy Team. 
...
\bibitem{Galaxy02} Blankenberg D, Von Kuster G, Coraor N, Ananda G, Lazarus R, Mangan M, Nekrutenko A, Taylor J. 
...
\bibitem{Galaxy03} Giardine B, Riemer C, Hardison RC, Burhans R, Elnitski L, Shah P, Zhang Y, Blankenberg D, Albert I, Taylor J, Miller W, Kent WJ, Nekrutenko A.
{\em Galaxy: a platform for interactive large-scale genome analysis.}
Genome Research. 2005 Oct; 15(10):1451-5.

\bibitem{protocol} Trapnell C, Roberts A, Goff L, Pertea G, Kim D, Kelley DR, Pimentel H, Salzberg SL, Rinn JL, Pachter L. 
...
\bibitem{tophat} Trapnell C, Pachter L, Salzberg SL. 
{\em TopHat: discovering splice junctions with RNA-Seq.}
Bioinformatics doi:10.1093/bioinformatics/btp120

\bibitem{tophat2} Kim D, Pertea G, Trapnell C, Pimentel H, Kelley R, Salzberg SL.
...
\bibitem{cufflinks} Trapnell C, Hendrickson D,Sauvageau S, Goff L, Rinn JL, Pachter L 
