...
Located under the galaxy installation (in our case \texttt{\footnotesize{\textbackslash usr\textbackslash local\textbackslash galaxy-dist}})  we will find a log file named \texttt{\footnotesize{paster.log}}.  This file is where the Galaxy instance will log messages while it is running on the system.
